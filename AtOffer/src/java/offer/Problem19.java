...
public class   Problem19 {
    ...
    private boolean matchCore(char[] str, int strStart, char[] pattern, int patternStart) {
        ...
        if((strStart < str.length && (str[strStart] == pattern[patternStart] || pattern[patternStart] == '.'))) {
    ...
    public static void main(String[] args) {
        Problem19 regularExpressionsMatching = new Problem19();
        ...
        System.out.println(regularExpressionsMatching.match("AAA".toCharArray(), ".*".toCharArray()));
