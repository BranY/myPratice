...
public class Problem06 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Problem06().printListFromTailToHead2(listNode));
        System.out.println(new Problem06().printListFromTailToHead3(listNode));
        System.out.println(new Problem06().printListFromTailToHead1(listNode));
        System.out.println(new Problem06().printListFromTailToHead(listNode));
